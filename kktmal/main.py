...
#두음법칙
n_to_o = ['녀','년','념','녕','뉴','닐','닉','뇨','뉵','니']
r_to_n = ['론','로','라','락','란','랄','람','랑','륵','록','루','릉','래','뢰','랍','랭','름','롱']
r_to_o = ['례','류','리','료','률','력','량','려','련','렴','령','린','립','렬','략','룡','륜','륙','륭','렵']
...
if a == "시작":
    ...
    toughness = input("난이도를 입력하세요.\nmedium 또는 hard\n")
    if toughness == "medium" or toughness == "hard":
        print("──────────────────────────────────────────────────")
        print("게임 시작")
        gamestate = 1
